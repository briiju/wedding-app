...
class Utility {
    ...
    async insertRsvp (params) {
        const query = `
        INSERT INTO haa_data.rsvp (full_name, phone, guests, message, attending)
        VALUES ($1, $2, $3, $4, $5)
        `;
        const values = [ params.fullName, params.phone, params.guests, params.message, params.attending ];
